...
export const pokeDex = [
  // pokemon missing moves: victrebell, beedrill, pideot, raticate, fearow, arbok, wiggly, vileplume, parasect, venomoth, primate, muk dewgong, cloyster, farf, dodrio, hypno, electrode, lickitung, electabuzz, eevee, moltres, zapdos.

  // i didnt think it was that many until i went through them all. 60/83
    {
        num: 1,
        name: 'Venusaur',
        types: ['Grass', 'Poison'],
        moves: ['growth', 'gigadrain', 'weatherball', 'earthpower'],
...

    {
        ...
        name: 'Butterfree',
        types: ['Bug', 'Flying'],
        moves: ['quiverdance', 'substitute', 'hurricane', 'sleeppowder'],
...

    {
        ...
        name: 'Clefable',
        types: ['Fairy'],
        moves: ['moonblast', 'softboiled', 'stealthrock', 'knockoff'],
...

    {
        ...
        name: 'Arcanine',
        types: ['Fire'],
        moves: ['flamethrower', 'morningsun', 'teleport', 'toxic'],
...

    {
        ...
        name: 'Slowbro',
        types: ['Water', 'Psychic'],
        moves: ['scald', 'icebeam','slackoff', 'futuresight'],
    ...
    
    {
        ...
        name: 'Onyx',
        types: ['Rock', 'Ground'],
        moves: ['earthquake', 'rockblast', 'stealthrock', 'explosion'],
...

    {
        ...
        name: 'Exeggutor',
        types: ['Grass', 'Psychic'],
        moves: ['futuresight', 'leafstorm', 'sleeppowder', 'psychic'],
...

    {
        ...
        name: 'Marowak',
        types: ['Ground'],
        moves: ['substitute', 'earthquake', 'knockoff', 'firepunch'],
...

    {
        ...
        name: 'Chansey',
        types: ['Normal'],
        moves: ['seismictoss', 'toxic', 'softboiled', 'teleport'],
...

    {
        ...
        name: 'Jolteon',
        types: ['Electric'],
        moves: ['thunderbold', 'voltswitch', 'shadowball' ,'toxic'],
...

    {
        ...
        name: 'Omastar',
        types: ['Rock', 'Water'],
        moves: ['shellsmash', 'meteorbeam', 'surf', 'icebeam'],
...

    {
        ...
        name: 'Dragonite',
        types: ['Dragon', 'Flying'],
        moves: ['icebeam', 'earthquake', 'roost', 'healbell'],
